...
[Back to Index](00-INDEX.md) | [Maturity Roadmap](06-MATURITY-ROADMAP.md) | [First 30 Days](02-FIRST-30-DAYS.md)
...
**Scoring:**
- **Yes** = 1 point (fully implemented)
- **Partial** = 0.5 points (partially implemented)
- **No** = 0 points (not implemented)

**Maturity Calculation:**
- Level 1: Score 2+ on Level 1 questions
- Level 2: Level 1 achieved + Score 2+ on Level 2 questions
- Level 3: Level 2 achieved + Score 2+ on Level 3 questions
...
**SM Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
| Level | Question | Yes | Partial | No |
|-------|----------|-----|---------|-----|
| L1 | Do you have an AI acceptable use policy? | [ ] | [ ] | [ ] |
...
**PC Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
**EG Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
**TA Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
**SR Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
| L2 | Is architecture reviewed for security before deployment? | [ ] | [ ] | [ ] |
...
**SA Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
| L2 | Do you have a design review checklist for AI systems? | [ ] | [ ] | [ ] |
...
**DR Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
**IR Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
| L1 | Do you test for data leakage (PII, prompts)? | [ ] | [ ] | [ ] |
...
**ST Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
**IM Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
**EH Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
**ML Score:** L1: ___/3 | L2: ___/3 | L3: ___/3 | **Maturity Level: ___**
...
- **Level 1 Maturity:** Achieved if average L1 score across all practices >=2.0
- **Level 2 Maturity:** Level 1 achieved + average L2 score >=2.0
- **Level 3 Maturity:** Level 2 achieved + average L3 score >=2.0

**Your Overall Maturity Level: _______**
...
**Priority:** Establish foundations
- Focus on [First 30 Days](02-FIRST-30-DAYS.md)
- Start with highest-risk practices per [Risk Matrix](05-RISK-PRACTICE-MATRIX.md)
- Target Level 1 across all practices

### If Most Practices Are Level 1:
**Priority:** Build structure
- Formalize processes and documentation
- Implement technical controls
- Target Level 2 for critical practices (ST, ML, EH)

### If Most Practices Are Level 2:
**Priority:** Optimize
- Focus on automation and metrics
- Benchmark against industry
- Target Level 3 for high-risk practices

### Gap Analysis

List practices with lowest scores:
...
**Next Steps:**
- [Maturity Roadmap](06-MATURITY-ROADMAP.md) - Plan your improvement path
- [First 30 Days](02-FIRST-30-DAYS.md) - Start implementing
- [Tools & Resources](08-TOOLS-RESOURCES.md) - Find tools to help
