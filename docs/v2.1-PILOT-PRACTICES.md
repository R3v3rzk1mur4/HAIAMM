# HAIAMM v2.1 Pilot Practices: Outcome-Oriented Specifications
...
The organization's ability to strategically manage AI-operated security programs and measure their effectiveness.
...
2. Define organizational risk tolerance for AI-operated security
   - Identify: High-risk vs. low-risk security functions
   - Determine: Which decisions require human approval vs. AI autonomy

3. Establish executive sponsorship for AI security program
   - Assign: C-level or VP-level owner for AI security operations
...
```json
{
  "metrics": [
    ...
    },
    {
      ...
      "target": "Track at least 3 KPIs for AI security operations",
...
1. **Leadership Accountability**
   ...
   - Clear ownership and sponsorship for AI security program
   - AI security operations are visible at executive level (not hidden in IT)
...
4. **Strategic Alignment**
   - AI security operations aligned with business objectives
...
**Objective:**
Continuously optimize AI security operations through data-driven decisions, industry benchmarking, and predictive analytics.
...
5. **Competitive Advantage**
   - Superior AI security operations enable business growth
...
**What this practice assesses:**
The organization's ability to identify threats to AI-operated security programs and assess risks specific to AI agents.

**Why outcomes matter here:**
Generic threat models miss AI-specific risks (prompt injection, model poisoning). Outcome focus ensures threat assessment is RELEVANT to AI security operations.
...
**Objective:**
Identify basic threats to AI security operations and establish foundational threat awareness.
...
1. Create threat model for AI security agent deployments
   ...
   - Document top 10 threats to AI security operations
  ...
  "criteria": [
    {
      ...
      "evidence": [
        ...
        "List of identified threats specific to AI security operations",
...
**Objective:**
Develop comprehensive threat scenarios for AI security operations and integrate threat intelligence into AI agent security.
...
4. Integrate threat assessment with business continuity planning
   ...
   - Recover: Procedures to restore AI security operations after incident
  ...
  "metrics": [
    {
      ...
      "target": "Document >5 multi-stage attack scenarios for AI security operations",
